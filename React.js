...
// Ans=> js stand for javascript it's a advance library of js,
//       it's use to create very fast UI(frontend) designe,
//       it's open source library and Developed and managed by Faceook
//       it did not render whole page again and again, it render only that component which we want to use

// Q.2=> Features of React ?
// Ans=> 1- JSX => js + HTML
//       2- Components
//       3- One-way data binding(source to destination) => parent to child (there is a different way of transfer data child to parent)
//       4- Virtual DOM => 
//       5- Simplicity
...
// what is jsx ==> html elements inside the component called jsx.

//  <React.Fragment></React.Fragment> or <></>
// if we use this tag it render only inside jsx code oetherwise outer div alsow render.

// Expression in JSX =>
// we can use javascript inside the jsx wit the help of curly braces({}) but we can't use statement inside it, is called Expression.
